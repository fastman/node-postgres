...
var clientBuilder = function(config) {
  ...
  connection.keepalives_idle     = connection._config.keepalives_idle;
  connection.keepalives_interval = connection._config.keepalives_interval;
  connection.keepalives_count    = connection._config.keepalives_count;
